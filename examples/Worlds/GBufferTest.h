...
World3D* createGBufferExample()
{
	...
	RoughBronzeObj->getInstance()->setPosition(vec3(0, -1, 0));
	...
	floorPlane->getMaterial()->setTexture(Gum::TextureManager::getTexture("Cobblestone/normal.png"), 14);
    ...
    floorPlane->getInstance()->setPosition(vec3(0, -1, 0));
